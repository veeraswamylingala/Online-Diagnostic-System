...
<style>
    ...
    <div class="part3">
        <br>
        <a href="AdminBookingDetails.php"><input type="button" value="Booking Details"></a>
        <a href="Adminuploadreports.php"><input type="button" value="upload Reports"></a>
        
         <a href="Adminregistration.php"><input type="button" value="Registartion"></a><br><br>
        <?php
