...
<body style="background-color:azure;">
    <form method="post" action="Adminuploadreports1.php">
    <div class="title">
...
<?php
        ...
        { 
            ?>
<a href="Admin.php" style="background:#3cb371">
         Admin
</a>
...
<style>
    div.part3 input[type="button"],input[type="submit"]
    {
    padding: 7px;
        color: black;        
        background:skyblue;
    ...
    <div class="part3" >
        <br>
        <a href="AdminBookingDetails.php">
            <input type="button" value="Booking Details"></a>
        <a href="Adminuploadreports.php">
            <input type="button" value="upload Reports"></a> 
         <a href="Adminregistration.php">
             <input type="button" value="Registartion"></a><BR><BR>
        <b>Enter Patient Name:</b>
        <input type="text" name="name"><br><br>
        <input type="file" 
               name="img1" placeholder="UploadImage"><br><br>
        <input type="file" 
               name="img2" placeholder="UploadImage"><br><br>
        <input type="file" 
               name="img3" placeholder="UploadImage"><br><br>
    <input type="submit" value="Upload" style="background:black;color:white;margin-left:170px;width:100px;">
    </div>
    <footer>
    <div class="bottom">
        <br>
